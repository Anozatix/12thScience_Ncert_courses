...
from source import *
root = Tk()
root.title("All courses in one click")
...
class links:
    def __init__(self):
        ...
        self.back_button=Button(root,text="<<",bg="blue",fg="white",command=self.back)
        self.main_menu()
    def main_menu(self):
